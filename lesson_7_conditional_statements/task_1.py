...
# CODUL TĂU VINE MAI JOS:
if "Python" in text: print('Textul conține cuvântul "Python"');
elif "Java" in text: print('Textul conține cuvântul "Java"');
else: print("Textul nu conține nici unul dintre cuvintele specificate");
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
if "Python" in text and "Java" in text: print('Textul conține cuvântul "Python" și cuvântul "Java"');
elif "Python" in text or "Java" in text: print('Textul conține cuvântul "Python" sau cuvântul "Java"');
else: print("Textul nu conține nici unul dintre cuvintele specificate");
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
number = int(input("Introduceți un număr de la 1 până la 5:"));
if number == 1: print("Unu") 
elif number == 2: print("Doi");
elif number == 3: print("Trei");
elif number == 4: print("Patru");
elif number == 5: print("Cinci");
# CODUL TĂU VINE MAI SUS:
