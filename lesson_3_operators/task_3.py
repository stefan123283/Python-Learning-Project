...
# CODUL TĂU VINE MAI JOS:
print(number + number3, number - number3, number * number3, number / number3, number % number3, number ** number3, number // number3);
# CODUL TĂU VINE MAI SUS:
